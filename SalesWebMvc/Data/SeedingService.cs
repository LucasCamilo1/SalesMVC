...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s3 = new Seller(3, "Alex Green", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            ...
            SalesRecord r2 = new SalesRecord(2, new DateTime(2018, 09, 26), 15000.0, SaleStatus.Billed, s3);
            SalesRecord r3 = new SalesRecord(3, new DateTime(2018, 09, 27), 13000.0, SaleStatus.Billed, s2);
            SalesRecord r4 = new SalesRecord(4, new DateTime(2018, 09, 28), 20000.0, SaleStatus.Billed, s4);
            SalesRecord r5 = new SalesRecord(5, new DateTime(2018, 09, 29), 25000.0, SaleStatus.Billed, s6);
            SalesRecord r6 = new SalesRecord(6, new DateTime(2018, 09, 30), 60000.0, SaleStatus.Billed, s5);
